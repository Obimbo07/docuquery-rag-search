...
```bash
git remote add encore encore://docuquery-rag-search-2o72
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/docuquery-rag-search-2o72/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/docuquery-rag-search-2o72/settings/integrations/github)
